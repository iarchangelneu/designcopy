...
export default {
    ...
    mounted() {
        ...
        const match = url.match(/order_pay_visuality_(\d+)/);
...
useSeoMeta({
    title: 'Ошибка | Design Market',
    ogTitle: 'Ошибка | Design Market',
    description: 'Ошибка | Design Market',
    ogDescription: 'Ошибка | Design Market',
})
</script>
<style scoped>
.success {
