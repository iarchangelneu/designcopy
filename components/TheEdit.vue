...
useSeoMeta({
    title: 'Редактирование товара | Design Market',
    ogTitle: 'Редактирование товара | Design Market',
    description: 'Редактирование товара | Design Market',
    ogDescription: 'Редактирование товара | Design Market',
})
</script>
<style scoped>
.creat__body button {
